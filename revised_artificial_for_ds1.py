...
#files = #['train_final.tsv']#,'valid_2.tsv']#'train_new_69.tsv',  'train_new_27.tsv', 'train_new_8.tsv', 'train_new_46.tsv',  'train_new_28.tsv','train_new_34.tsv','train_new_44.tsv', 'train_new_25.tsv', ''train_new_15.tsv','train_new_32.tsv', 'train_new_66.tsv', 'train_new_79.tsv', 'train_new_20.tsv','train_new_71.tsv','train_new_30.tsv','train_new_63.tsv', 'train_new_1.tsv','train_new_2.tsv', 'train_new_87.tsv', 'train_new_3.tsv', 'train_new_43.tsv', 
onlyfiles = [ 'train_new_38.tsv', 'train_new_86.tsv', 'train_new_76.tsv', 'train_new_26.tsv', 'train_new_83.tsv', 'train_new_61.tsv', 
   ...
   'train_new_9.tsv', 'train_new_42.tsv', 'train_new_29.tsv', 'train_new_11.tsv', 'train_new_17.tsv', 'train_new_60.tsv',
    'train_new_67.tsv', 'train_new_37.tsv', 'train_new_70.tsv', 'train_new_23.tsv', 'train_new_6.tsv', 'train_new_78.tsv',
     'train_new_16.tsv', 'train_new_33.tsv', 'train_new_59.tsv', 'train_new_88.tsv', 'train_new_56.tsv', 'train_new_74.tsv',
      'train_new_13.tsv', 'train_new_54.tsv', 'train_new_49.tsv', 'train_new_22.tsv' ]
